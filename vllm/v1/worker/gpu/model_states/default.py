...
# Encoder-only attention never indexes block tables or allocates a KV cache.
_ENCODER_ONLY_KV_GROUP_ID = -1
...
class DefaultModelState(ModelState):
    ...
    def _init_encoder_only_attn_groups(self) -> list[AttentionGroup]:
        ...
        return create_attn_groups(
            self.vllm_config, layer_specs, _ENCODER_ONLY_KV_GROUP_ID
        )
